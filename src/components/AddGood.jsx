...
function AddGood() {
    ...
    useEffect(() => {
      axios.get('https://dava-ecommerce.herokuapp.com/dashcheck',{
        headers:{
    ...
    const addgood=()=>{
             const data= new FormData()
              ...
              var imgdesc = Inpute
            axios.post('https://dava-ecommerce.herokuapp.com/', {myfile,nameofgood,amountinnaira,numberavailable,imgdesc}).then((res)=>{
